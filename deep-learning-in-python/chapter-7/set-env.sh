...
git clone https://github.com/khalil36/deep-learning.git

# copy the script into the container; note: the resulting file is owned by root and it not executable
docker cp ~/tutorial/deep-learning/prepareContainer.sh jupyter:/tmp/prepareContainerRoot.sh

docker cp  ~/tutorial/deep-learning/chapter-7/. jupyter:/home/jovyan/work
